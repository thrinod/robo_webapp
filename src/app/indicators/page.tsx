...
export default function IndicatorsPage() {
    ...
    useEffect(() => {
        ...
        if (autoRefresh && expiry) {
            interval = setInterval(() => fetchData(true), Math.max(1, refreshSeconds) * 1000);
        }
        return () => clearInterval(interval);
    }, [autoRefresh, expiry, fetchData, refreshSeconds]);
            ...
            <Paper className="p-4 grid grid-cols-1 md:grid-cols-4 gap-4 items-center shadow-sm bg-white dark:bg-gray-800 dark:border-gray-700">
                ...
                <div className="flex items-center space-x-2">
                    ...
                    <TextField
                        ...
                        onChange={e => setRefreshSeconds(Math.max(1, parseInt(e.target.value) || 1))}
