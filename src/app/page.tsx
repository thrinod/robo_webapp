    ...
    <div className="flex flex-col items-center justify-center min-h-[60vh] space-y-12 p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 w-full max-w-7xl">
        <div 
          ...
          className="group p-8 bg-white dark:bg-[#252d3d] rounded-3xl border border-gray-200 dark:border-[#4a6fa5] shadow-sm hover:shadow-xl hover:border-indigo-500/50 transition-all cursor-pointer"
        >
          ...
          <p className="text-gray-500 dark:text-slate-400 text-sm">Analyze Greeks and execute multi-leg strategies in real-time.</p>
        </div>
        ...
        >
          ...
          <p className="text-gray-500 dark:text-slate-400 text-sm">Monitor your P&L and automate exits with precision SL/Targets.</p>
        </div>
        ...
        >
          ...
          <p className="text-gray-500 dark:text-slate-400 text-sm">Track simulated positions and view historical performance.</p>
        </div>
        ...
        >
          ...
          <p className="text-gray-500 dark:text-slate-400 text-sm">Manage Upstox, Mirae Asset, and Telegram integrations.</p>
        </div>
      </div>

      <div className="flex items-center gap-2 p-4 bg-gray-100 dark:bg-[#252d3d]/50 rounded-2xl border border-gray-200 dark:border-[#4a6fa5]">
